...
var Bounds = exports.Bounds = function () {
    ...
    _createClass(Bounds, null, [{
        ...
        value: function fromClientRect(clientRect, scrollX, scrollY) {
            alert("method fromClientRect (output of getBoundingClientRect): " + clientRect.left);
...
var CanvasRenderer = function () {
    ...
    _createClass(CanvasRenderer, [{
        ...
        value: function render(options) {
            ...
            alert("options.x und y " + options.x + " " + options.y);
...
var renderElement = exports.renderElement = function renderElement(element, options, logger) {
    ...
    alert("WINDOWBOUNDS:  " + options.scrollX + " " + options.scrollY + " " + options.windowWidth + " " + options.windowHeight ); 
    // http://www.w3.org/TR/css3-background/#special-backgrounds
    alert(ownerDocument.documentElement);
    ...
    _Feature2.default.SUPPORT_FOREIGNOBJECT_DRAWING : Promise.resolve(false)).then(function (supportForeignObject) {
        return supportForeignObject ? function (cloner) {
            ...
            return resourceLoader.ready().then(function (imageStore) {
                ...
                alert("crop x " + options.x + " y " + options.y);
                alert("option width " + options.width + "option heigt " + options.height);
                var renderOptions = {
                    backgroundColor: backgroundColor,
