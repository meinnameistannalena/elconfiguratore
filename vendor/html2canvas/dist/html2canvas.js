...
function renderWindow(node, container, options, windowWidth, windowHeight) {
    ...
    // ALF: Bugfix von github, weiterer Fix notwendig siehe getBounds
...
exports.getBounds = function(node) {
    if (node.getBoundingClientRect) {
        ...
        // ALF: Hinzugefügt, damit PDF nicht abgeschnitten wird, wenn oberer Bereich nicht im Viewport ist
        var top = 0;
        var bottom = 0;
        //var scrollLeft = window.pageXOffset || document.documentElement.scrollLeft;
        var scrollTop = window.pageYOffset || document.documentElement.scrollTop;
        alert("SCROLLTOP " + scrollTop);
        alert("clientRect.top " + clientRect.top);
        alert("clientRect.bottom " + clientRect.bottom);
        if(clientRect.top >= 0){
        //AFI -1 wegen 
           top = clientRect.top+scrollTop-1;
           bottom = clientRect.bottom+scrollTop+1;
        } else {      
            alert("2");      
